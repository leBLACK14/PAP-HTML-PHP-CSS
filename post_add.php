<?php
	...
	if(!isset($_SESSION['user']))
	{
		...
		echo '<div class="erro">Não tem permissão para ver o conteudo da pagina.<br><br>
	...
	echo '<div class="dados_utilizador">
			<img src="image/avatar/'.$_SESSION['avatar'].'"><span>'.$_SESSION['user'].'</span> | <a href="logout.php">Logout</a>
		</div>';
	...
	else
	{
		...
		$motor = $ligacao->prepare("UPDATE posts SET titulo = :tit, mensagem =
		:mess, data_post = :dat WHERE id_post = :pid");
