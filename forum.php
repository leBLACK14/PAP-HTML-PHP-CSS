<?php
	...
	if(!isset($_SESSION['user']))
	{
		...
		echo '<div class="erro">Não tem permissão para ver o conteudo do forum.<br><br>
	...
	echo '<div class="dados_utilizador">
			<img src="image/avatar/'.$_SESSION['avatar'].'"><span>'.$_SESSION['user'
	...
	else
	{
		...
		foreach($motor as $post)
		{
			...
			//dados do user
			echo '<img src="image/avatar/'.$avatar.'">';
			...
			{
				echo '<a href="editor_post.php?pid='.$id_post.'"
				id="editar">Editar</a>';
			}
			echo $data_post;
	...
	echo '<div class="contador">
			Número de utilizadores registados: <strong>'.$numUsers.'</strong> |
